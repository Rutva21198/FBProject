...
namespace FacebookProjectRxWeb.Models.Main
{
    ...
    public partial class UserDetail
    {
        ...
        [RelationshipTableAttribue("FacebookApplicationObject","dbo","","RelationshipAO")]
        ...
        [InverseProperty(nameof(FacebookProjectRxWeb.Models.Main.CoverPhoto.UserDetails))]
        ...
        [InverseProperty(nameof(FacebookProjectRxWeb.Models.Main.FacebookUser.UserDetails))]
        ...
        [InverseProperty(nameof(FacebookProjectRxWeb.Models.Main.FacebookApplicationObject.UserDetails))]
        ...
        [InverseProperty(nameof(FacebookProjectRxWeb.Models.Main.ProfilePhoto.UserDetails))]
